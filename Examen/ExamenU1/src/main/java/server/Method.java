...
public class Method {
    ...
    public static String generarCurp(String apellido_Pat, String apellido_Mat, String nombre, String sexo, String fecha_Nac, String estado_Nac) {
        ...
        char anio = fecha_Nac.charAt(9);
        char anio2 = fecha_Nac.charAt(8);
        char mes = fecha_Nac.charAt(4);
        char mes2 = fecha_Nac.charAt(3);
        char dia = fecha_Nac.charAt(1);
        char dia2 = fecha_Nac.charAt(0);
        ...
        char c14 = apellido_Pat.charAt(3);
        char c15 = apellido_Mat.charAt(3);
        ...
        String message = Character.toUpperCase(ap)+Character.toUpperCase(ap2)+Character.toUpperCase(am)+Character.toUpperCase(nm)+anio2+anio+mes2+mes+dia2+dia+Character.toUpperCase(s)+est+Character.toUpperCase(c14)+Character.toUpperCase(c15)+Character.toUpperCase(c16)+as+an;
